...
@section('content_header')
    <h1>Actualización del inventario</h1>
    <hr>
@stop
...
<div>
    <div class="container ">
        ...
        <div class = " card shadow ab-4 btaura" >
            ...
            <h5 class = "n-font-weight-bold text-black">Actualización del inventario </h5 > 
        </div >

        <div class="m-0 text-center align-items-center justify-content-center">
            <div class="bg-light p-5">
        <form action="{{route('inventario.update', $inventario)}}" method="POST" autocomplete="off">
            @method('put')
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                        ...
                        placeholder="Ingrese una descripción" oninput="validateTextarea()" id="myTextarea"
                        name="descripcion" maxlength="150">{{old('descripcion', $inventario->descripcion)}}</textarea>
                        @error('descripcion')
                        <small class="text-danger invalid-feedback"><strong>*</strong>{{$message}}</small>
                        @enderror
                </div>
