...
<div>
  ...
  <div class="container">
    <div class="mb-3 text-end">
      <a class="btn btn-outline-primary text-BLACK" href="{{route('constructora.create')}}">Nueva constructora<i class="bi bi-person-plus"></i></a>
  </div>
        ...
        <div class = " card shadow ab-4 btaura" >
          <div class = " card-header py-3 " >
              <a href="{{route('constructora.index')}}" id="sinLinea">
                <h6 class = "n-font-weight-bold" title="Volver a todos los registros">Listado de constructoras </h6></a> 
          </div >
                  ...
                  @forelse($constructoras as $constructora)
                    <tr>
                      ...
                      <td><a class="btn btn-outline-warning" 
                        href="{{route('constructora.edit', ['id' => $constructora->id])}}">
