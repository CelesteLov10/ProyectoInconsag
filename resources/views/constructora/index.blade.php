...
@section('titulo', 'Listado de constructora')
...
<div>
  ...
  <div class="container">
    <div class="mb-3 text-end">
      <a class="btn glow-on-hover-main text-BLACK" href="{{route('constructora.create')}}">Nueva constructora<i class="bi bi-person-plus"></i></a>
  </div>
