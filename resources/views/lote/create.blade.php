...
@section('content_header')
    <h1>Registro de lotes para el bloque</h1>
@stop
    ...
    <div class="container ">
        ...
        <div class=" card shadow ab-4 btaura">
            <div class=" card-header py-3 ">
                <h5 class="n-font-weight-bold text-black">Registro de lotes </h5>
            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <select name="bloque_id" id="bloque_id"
                                        class="form-select form-control rounded-pill @error('bloque_id') is-invalid @enderror"
