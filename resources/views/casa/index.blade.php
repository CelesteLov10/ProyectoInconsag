...
@section('content_header')
    <h1>Listado de casas modelos</h1>
    <hr>
@stop
...
<div>
  ...
  <div class="container">
    <div class="mb-3 text-end">
      <a class="btn btn-outline-primary text-BLACK" href="{{route('casa.create')}}">Nueva casa <i class="bi bi-house-fill"></i></a>
  </div>
        ...
        <div class = " card shadow ab-4 btaura" >
          <div class = " card-header py-3 " >
              <a href="{{route('casa.index')}}" id="sinLinea">
                <h6 class = "n-font-weight-bold" title="Volver a todos los registros">Listado de casas </h6 ></a> 
          </div >
                  ...
                  @forelse($casa as $casas)
                    <tr>
                      ...
                      <td><a class="btn btn-outline-primary" 
                        href="{{route('casa.show', ['id'=>$casas->id])}}">
                        <i class="fa fa-eye"></i> 
                      </a></td>
