      ...
      <form action="{{route('casa.update', $casa)}}" id="formu" class="casa-actualizar" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-5">
            ...
            value="{{old('cantHabitacion', $casa->cantHabitacion)}}" maxlength="1">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-5">
            ...
            maxlength="150" placeholder="Ingrese la descripción" name="descripcion" oninput="validateTextarea()" id="myTextarea"
