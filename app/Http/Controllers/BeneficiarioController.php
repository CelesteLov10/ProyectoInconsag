...
class BeneficiarioController extends Controller
{
    ...
    public function store(Request $request)
    {
            ...
            'direccionBen.required' => 'La dirección es obligatorio, no puede estar vacío.',
            ...
            'cliente_id' => 'La nombre del cliente es obligatorio, no puede estar vacío. ',
    ...
    public function update(Request $request, $id){
        ...
        $this->validate($request,[
            ...
            'direccionBen.required' => 'La dirección es obligatoria, no puede estar vacío.',
            'direccionBen.min' => 'La dirección es muy corta. Ingrese entre 10 y 150 caracteres',
            'direccionBen.max' => 'La dirección sobrepasa el límite de caracteres',
